# registry-dashboard — Feature Knowledge

## Why this feature matters

Landing view of the Registry portal; opens straight onto the Parties register, so it shares that feature's substance.

## What will bite you

- A separate SPA on `:8446`'s sibling port `:8445` with its own navigation idiom (emoji-prefixed
