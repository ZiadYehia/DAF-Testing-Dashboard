# Partial Dispensing — API Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | Partial Dispensing |
| **Slug** | `api-partial-dispensing` |
| **Feature ID** | `EPTTS_API_11` |
| **Module** | EPTTS APIs |
...
**Distinctive fields** — `quantity`: the number of units dispensed

**EPC carrier** — epcList: the SGTIN being partially dispensed
