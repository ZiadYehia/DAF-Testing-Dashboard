# web-audit-master-data-changes — Feature Knowledge
...
- This is a **tab**, not a route: it lives at `/audit` and is only reachable by clicking **Master-data changes**. There is no deep link, so a test must navigate then click.
