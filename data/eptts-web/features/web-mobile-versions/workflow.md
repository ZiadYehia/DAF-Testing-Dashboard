# Mobile Versions — Dashboard Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | Mobile Versions |
| **Slug** | `web-mobile-versions` |
| **Feature ID** | `EPTTS_WEB_57` |
| **Module** | administration |
| **Portal** | https://192.168.225.195:8444 |
| **Route** | `/mobile-versions` |
| **Text direction** | ltr |
| **Priority** | P3 |
...
| Element | Type | Detail |
|---------|------|--------|
| Mobile Versions | Heading | — |
| Mobile App Versions | Heading | — |
| AR | Button / action | — |
| Add Version | Button / action | — |
| 1 | Button / action | — |
| Table 1 | Table | columns: ID, ANDROID VERSION, ANDROID STATUS, IOS VERSION, IOS STATUS, CREATED, ACTIONS |

## Displayed metrics

- 1 TOTAL 1 ANDROID ACTIVE 1 IOS ACTIVE
- 1 TOTAL
- 1 ANDROID ACTIVE
- 1 IOS ACTIVE
...
3. Navigate to `/mobile-versions`.
4. The page loads with the heading "Mobile Versions".
...
GET 200 /masar-service/api/v1/mobile-versions
```
