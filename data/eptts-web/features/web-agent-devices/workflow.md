# Desktop Agent Devices — Dashboard Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | Desktop Agent Devices |
| **Slug** | `web-agent-devices` |
| **Feature ID** | `EPTTS_WEB_61` |
...
| Element | Type | Detail |
|---------|------|--------|
| Desktop Agent - Devices | Heading | — |
| Device Management | Heading | — |
| AR | Button / action | — |
| All (0) | Button / action | — |
| Pending (0) | Button / action | — |
| Active (0) | Button / action | — |
| Revoked (0) | Button / action | — |
| Table 1 | Table | columns: DEVICE NAME, DEVICE UUID, STATUS, VERSION, LAST CONNECTION, FINGERPRINT, ACTIONS |

## Displayed metrics

- 0 TOTAL 0 PENDING 0 ACTIVE 0 REVOKED
- 0 TOTAL
- 0 PENDING
- 0 ACTIVE
- 0 REVOKED
...
3. Navigate to `/agent-devices`.
4. The page loads with the heading "Desktop Agent Devices".
