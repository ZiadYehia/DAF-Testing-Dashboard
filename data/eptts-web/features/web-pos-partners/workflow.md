# POS Partners — Dashboard Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | POS Partners |
| **Slug** | `web-pos-partners` |
| **Feature ID** | `EPTTS_WEB_59` |
| **Module** | integrations |
...
| Element | Type | Detail |
|---------|------|--------|
| POS Partners | Heading | — |
| AR | Button / action | — |
| New POS Partner | Button / action | — |
| Table 1 | Table | columns: NAME, CONTACT, API KEY, STATUS, CREATED, ACTIONS |

## Displayed metrics

- 0 Total 0 Active 0 Suspended 0 Sandbox
- 0 Total
- 0 Active
- 0 Suspended
- 0 Sandbox
...
3. Navigate to `/pos-partners`.
4. The page loads with the heading "POS Partners".
...
GET 200 https://192.168.225.195:8445/registry-service/api/v1/admin/integrators
```
