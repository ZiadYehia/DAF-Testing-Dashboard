# Analytics — Activity — Dashboard Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | Analytics — Activity |
| **Slug** | `web-analytics-activity` |
| **Feature ID** | `EPTTS_WEB_28` |
| **Module** | Platform Dashboard |
| **Route** | `/analytics` → tab **Activity** |
...
| Element | Type | Detail |
|---------|------|--------|
| Table | Table | columns: BUSINESS STEP, NET UNITS, GROSS EVENTS |
| AR | Button / action | — |
...
- Discovered live on 2026-08-31 by opening the **Activity** tab on `/analytics`.
