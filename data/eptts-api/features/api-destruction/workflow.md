# Destruction — API Workflow

## Feature Details

| Field | Value |
|-------|-------|
| **Feature Name** | Destruction |
| **Slug** | `api-destruction` |
| **Feature ID** | `EPTTS_API_05` |
| **Module** | EPTTS APIs |
| **Endpoint** | `POST /scp/SendEPCIS` |
| **Acting role** | Any holder of the pack |
...
**EPC carrier** — epcList: the SGTINs / SSCCs to destroy
...
Final state: each pack becomes **Destroyed**.
