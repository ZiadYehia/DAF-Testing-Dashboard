 ...
 *
 * Usage:
 *   node scripts/eptts-api-postman.js            # dry run (prints a summary)
 *   node scripts/eptts-api-postman.js --write
 *
 ...
 * data/eptts-api/modules/eptts-apis/knowledge/verified-live-contract.md. It differs
...
function build() {
  ...
  return {
    info: {
      ...
      description: [
        'Generated by scripts/eptts-api-postman.js from the contract verified against',
