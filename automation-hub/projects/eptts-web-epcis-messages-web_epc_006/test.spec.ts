/**
 * WEB_EPC_006 — Validate that search handles a no-match value without error
 *
...
test('WEB_EPC_006 — Validate that search handles a no-match value without error', async ({ page }) => {
  test.slow()
