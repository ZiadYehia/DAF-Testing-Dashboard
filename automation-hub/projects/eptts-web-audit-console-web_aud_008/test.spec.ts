/**
 * WEB_AUD_008 — Validate that a non-privileged role cannot reach this page
 *
...
test('WEB_AUD_008 — Validate that a non-privileged role cannot reach this page', async ({ browser }) => {
  test.slow()
  ...
  try {
    await page.goto(baseUrl('eptts-web') + '/audit', { waitUntil: 'domcontentloaded', timeout: 45_000 })
