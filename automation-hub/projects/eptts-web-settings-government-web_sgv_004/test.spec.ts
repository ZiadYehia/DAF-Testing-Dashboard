/**
 * WEB_SGV_004 — Validate that the Government tab reloads its data after a page refresh
 *
...
test('WEB_SGV_004 — Validate that the Government tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
