/**
 * WEB_AGM_008 — Validate that the page handles an expired session
 *
...
test('WEB_AGM_008 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/agent-monitoring').expectEnglish()
