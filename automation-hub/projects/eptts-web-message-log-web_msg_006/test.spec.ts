/**
 * WEB_MSG_006 — Validate that the page handles an expired session
 *
...
test('WEB_MSG_006 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/message-log').expectEnglish()
