/**
 * WEB_PHS_002 — Validate that /pharmacy-stock is reachable by direct URL and survives a refresh
 *
...
test('WEB_PHS_002 — Validate that /pharmacy-stock is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/pharmacy-stock')
    .expectEnglish()
    .expectSurvivesReload('/pharmacy-stock')
    .expectNoErrorBanner()
})
