/**
 * WEB_VIO_002 — Validate that /violations is reachable by direct URL and survives a refresh
 *
...
test('WEB_VIO_002 — Validate that /violations is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/violations')
    .expectEnglish()
    .expectSurvivesReload('/violations')
    .expectNoErrorBanner()
})
