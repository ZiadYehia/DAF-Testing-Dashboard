/**
 * WEB_CSV_007 — Validate that the page handles an expired session
 *
...
test('WEB_CSV_007 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/import-jobs').expectEnglish()
