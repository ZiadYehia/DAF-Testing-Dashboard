/**
 * WEB_VIO_006 — Validate that the page handles an expired session
 *
...
test('WEB_VIO_006 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/violations').expectEnglish()
