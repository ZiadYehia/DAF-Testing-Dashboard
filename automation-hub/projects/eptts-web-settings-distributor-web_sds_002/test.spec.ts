/**
 * WEB_SDS_002 — Validate that the Distributor tab reloads its data after a page refresh
 *
...
test('WEB_SDS_002 — Validate that the Distributor tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
