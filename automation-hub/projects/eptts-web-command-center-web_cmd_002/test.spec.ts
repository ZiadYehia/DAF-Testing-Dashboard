/**
 * WEB_CMD_002 — Validate that /dashboard is reachable by direct URL and survives a refresh
 *
...
test('WEB_CMD_002 — Validate that /dashboard is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/dashboard')
    .expectEnglish()
    .expectSurvivesReload('/dashboard')
    .expectNoErrorBanner()
})
