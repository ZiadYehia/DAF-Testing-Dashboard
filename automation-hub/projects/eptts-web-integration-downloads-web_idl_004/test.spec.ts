/**
 * WEB_IDL_004 — Validate that the page handles an expired session
 *
...
test('WEB_IDL_004 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/integration-downloads').expectEnglish()
