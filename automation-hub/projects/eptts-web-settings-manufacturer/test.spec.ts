/**
 * WEB_SMF_001 — Manufacturer renders with its content and primary controls.
 *
 * Feature: web-settings-manufacturer   Route: /admin
 *
...
test('WEB_SMF_001 — Manufacturer renders', async ({ page }) => {
  test.slow()
  await DashboardPage.openTab(page, '/admin', 'Manufacturer')
    .expectEnglish()
    .expectControls(['Export', 'Add Manufacturer'])
    .expectTableColumns(['NAME', 'GLN', 'SGLN', 'PREFIX', 'CONTACT INFO'])
