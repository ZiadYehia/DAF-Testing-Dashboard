/**
 * WEB_SET_007 — Validate that search handles a no-match value without error
 *
...
test('WEB_SET_007 — Validate that search handles a no-match value without error', async ({ page }) => {
  test.slow()
