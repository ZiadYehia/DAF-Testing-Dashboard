/**
 * WEB_CXL_006 — Validate that the page handles an expired session
 *
...
test('WEB_CXL_006 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/cancellations').expectEnglish()
