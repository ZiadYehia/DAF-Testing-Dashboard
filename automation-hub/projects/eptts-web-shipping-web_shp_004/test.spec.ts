/**
 * WEB_SHP_004 — Validate that the page handles an expired session
 *
...
test('WEB_SHP_004 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/shipments').expectEnglish()
