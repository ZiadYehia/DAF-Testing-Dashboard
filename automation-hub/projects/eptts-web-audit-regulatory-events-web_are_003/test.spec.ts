/**
 * WEB_ARE_003 — Validate that Regulatory events data is not carried over from another tab
 *
...
test('WEB_ARE_003 — Validate that Regulatory events data is not carried over from another tab', async ({ page }) => {
  test.slow()
