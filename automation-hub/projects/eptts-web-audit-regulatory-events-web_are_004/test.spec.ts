/**
 * WEB_ARE_004 — Validate that the Regulatory events tab reloads its data after a page refresh
 *
...
test('WEB_ARE_004 — Validate that the Regulatory events tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
