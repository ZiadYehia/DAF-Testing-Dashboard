/**
 * WEB_NSH_003 — Validate that Shipments data is not carried over from another tab
 *
...
test('WEB_NSH_003 — Validate that Shipments data is not carried over from another tab', async ({ page }) => {
  test.slow()
