/**
 * WEB_EPC_008 — Validate that the page handles an expired session
 *
...
test('WEB_EPC_008 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/epcis-b2b').expectEnglish()
