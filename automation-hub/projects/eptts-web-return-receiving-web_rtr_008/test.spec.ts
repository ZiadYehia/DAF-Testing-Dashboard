/**
 * WEB_RTR_008 — Validate that the page handles an expired session
 *
...
test('WEB_RTR_008 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/pending-returns').expectEnglish()
