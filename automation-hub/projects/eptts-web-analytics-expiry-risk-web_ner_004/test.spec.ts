/**
 * WEB_NER_004 — Validate that the Expiry risk tab reloads its data after a page refresh
 *
...
test('WEB_NER_004 — Validate that the Expiry risk tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
