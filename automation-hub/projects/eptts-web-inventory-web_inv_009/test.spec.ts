/**
 * WEB_INV_009 — Validate that the page handles an expired session
 *
...
test('WEB_INV_009 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/inventory').expectEnglish()
