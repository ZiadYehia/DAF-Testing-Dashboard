/**
 * WEB_INF_003 — Validate that search filters the result set
 *
...
test('WEB_INF_003 — Validate that search filters the result set', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/information-center')
    .expectEnglish()
    .expectSearchFilters('Search', 'a')
})
