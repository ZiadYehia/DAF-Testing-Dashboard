/**
 * WEB_IPK_004 — Validate that the page handles an expired session
 *
...
test('WEB_IPK_004 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/aggregation/individual-packs').expectEnglish()
