/**
 * WEB_AGD_002 — Validate that /agent-devices is reachable by direct URL and survives a refresh
 *
...
test('WEB_AGD_002 — Validate that /agent-devices is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/agent-devices')
    .expectEnglish()
    .expectSurvivesReload('/agent-devices')
    .expectNoErrorBanner()
})
