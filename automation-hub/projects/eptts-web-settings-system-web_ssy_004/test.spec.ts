/**
 * WEB_SSY_004 — Validate that the System tab reloads its data after a page refresh
 *
...
test('WEB_SSY_004 — Validate that the System tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
