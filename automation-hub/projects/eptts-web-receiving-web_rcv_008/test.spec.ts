/**
 * WEB_RCV_008 — Validate that the page handles an expired session
 *
...
test('WEB_RCV_008 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/shipments/receive').expectEnglish()
