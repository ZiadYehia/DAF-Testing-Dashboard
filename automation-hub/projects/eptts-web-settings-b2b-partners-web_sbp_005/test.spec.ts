/**
 * WEB_SBP_005 — Validate that B2B Partners never displays a full API key
 *
...
test('WEB_SBP_005 — Validate that B2B Partners never displays a full API key', async ({ page }) => {
  test.slow()
