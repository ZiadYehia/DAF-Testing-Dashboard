/**
 * WEB_SGE_003 — Validate that Geography data is not carried over from another tab
 *
...
test('WEB_SGE_003 — Validate that Geography data is not carried over from another tab', async ({ page }) => {
  test.slow()
