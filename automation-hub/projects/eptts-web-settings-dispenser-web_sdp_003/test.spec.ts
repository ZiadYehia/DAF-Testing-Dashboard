/**
 * WEB_SDP_003 — Validate that Dispenser data is not carried over from another tab
 *
...
test('WEB_SDP_003 — Validate that Dispenser data is not carried over from another tab', async ({ page }) => {
  test.slow()
