/**
 * WEB_PRD_002 — Validate that /products is reachable by direct URL and survives a refresh
 *
...
test('WEB_PRD_002 — Validate that /products is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/products')
    .expectEnglish()
    .expectSurvivesReload('/products')
    .expectNoErrorBanner()
})
