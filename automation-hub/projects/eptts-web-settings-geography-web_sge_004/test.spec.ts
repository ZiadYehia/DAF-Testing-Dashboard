/**
 * WEB_SGE_004 — Validate that the Geography tab reloads its data after a page refresh
 *
...
test('WEB_SGE_004 — Validate that the Geography tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
