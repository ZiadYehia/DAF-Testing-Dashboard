/**
 * WEB_SBP_001 — Validate that the B2B Partners tab opens and loads its own content
 *
...
test('WEB_SBP_001 — Validate that the B2B Partners tab opens and loads its own content', async ({ page }) => {
  test.slow()
