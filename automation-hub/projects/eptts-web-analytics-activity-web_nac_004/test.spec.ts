/**
 * WEB_NAC_004 — Validate that the Activity tab reloads its data after a page refresh
 *
...
test('WEB_NAC_004 — Validate that the Activity tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
