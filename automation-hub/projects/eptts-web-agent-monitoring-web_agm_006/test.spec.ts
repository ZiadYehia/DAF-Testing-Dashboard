/**
 * WEB_AGM_006 — Validate that search handles a no-match value without error
 *
...
test('WEB_AGM_006 — Validate that search handles a no-match value without error', async ({ page }) => {
  test.slow()
