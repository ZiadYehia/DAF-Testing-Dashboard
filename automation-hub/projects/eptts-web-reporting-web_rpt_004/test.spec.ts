/**
 * WEB_RPT_004 — Validate that the table renders an empty state when no records match
 *
...
test('WEB_RPT_004 — Validate that the table renders an empty state when no records match', async ({ page }) => {
  test.slow()
