/**
 * WEB_ANL_007 — Validate that the page handles an expired session
 *
...
test('WEB_ANL_007 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/analytics').expectEnglish()
