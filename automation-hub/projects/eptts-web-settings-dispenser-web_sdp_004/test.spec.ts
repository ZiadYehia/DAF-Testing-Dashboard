/**
 * WEB_SDP_004 — Validate that the Dispenser tab reloads its data after a page refresh
 *
...
test('WEB_SDP_004 — Validate that the Dispenser tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
