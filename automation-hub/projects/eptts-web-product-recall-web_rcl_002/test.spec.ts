/**
 * WEB_RCL_002 — Validate that /recalls is reachable by direct URL and survives a refresh
 *
...
test('WEB_RCL_002 — Validate that /recalls is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/recalls')
    .expectEnglish()
    .expectSurvivesReload('/recalls')
    .expectNoErrorBanner()
})
