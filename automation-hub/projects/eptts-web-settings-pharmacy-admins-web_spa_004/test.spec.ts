/**
 * WEB_SPA_004 — Validate that the Pharmacy Admins tab reloads its data after a page refresh
 *
...
test('WEB_SPA_004 — Validate that the Pharmacy Admins tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
