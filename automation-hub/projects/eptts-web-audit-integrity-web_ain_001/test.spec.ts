/**
 * WEB_AIN_001 — Validate that the Integrity tab opens and loads its own content
 *
...
test('WEB_AIN_001 — Validate that the Integrity tab opens and loads its own content', async ({ page }) => {
  test.slow()
