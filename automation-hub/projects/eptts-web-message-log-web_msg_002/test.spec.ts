/**
 * WEB_MSG_002 — Validate that /message-log is reachable by direct URL and survives a refresh
 *
...
test('WEB_MSG_002 — Validate that /message-log is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/message-log')
    .expectEnglish()
    .expectSurvivesReload('/message-log')
    .expectNoErrorBanner()
})
