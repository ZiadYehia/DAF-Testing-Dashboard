/**
 * WEB_NIV_004 — Validate that the Inventory tab reloads its data after a page refresh
 *
...
test('WEB_NIV_004 — Validate that the Inventory tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
