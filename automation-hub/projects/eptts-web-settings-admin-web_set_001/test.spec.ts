/**
 * WEB_SET_001 — Validate that the Settings page renders with its heading and primary controls
 *
...
test('WEB_SET_001 — Validate that the Settings page renders with its heading and primary controls', async ({ page }) => {
  test.slow()
