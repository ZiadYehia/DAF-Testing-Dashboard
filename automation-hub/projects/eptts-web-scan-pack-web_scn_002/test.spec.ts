/**
 * WEB_SCN_002 — Validate that /scanning is reachable by direct URL and survives a refresh
 *
...
test('WEB_SCN_002 — Validate that /scanning is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/scanning')
    .expectEnglish()
    .expectSurvivesReload('/scanning')
    .expectNoErrorBanner()
})
