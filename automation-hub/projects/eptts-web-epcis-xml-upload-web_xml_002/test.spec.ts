/**
 * WEB_XML_002 — Validate that /bulk-upload is reachable by direct URL and survives a refresh
 *
...
test('WEB_XML_002 — Validate that /bulk-upload is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/bulk-upload')
    .expectEnglish()
    .expectSurvivesReload('/bulk-upload')
    .expectNoErrorBanner()
})
