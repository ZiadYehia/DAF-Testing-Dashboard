/**
 * WEB_THS_008 — Validate that the page handles an expired session
 *
...
test('WEB_THS_008 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/shipments/history').expectEnglish()
