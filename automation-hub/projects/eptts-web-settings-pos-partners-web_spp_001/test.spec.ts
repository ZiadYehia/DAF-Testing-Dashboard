/**
 * WEB_SPP_001 — Validate that the POS Partners tab opens and loads its own content
 *
...
test('WEB_SPP_001 — Validate that the POS Partners tab opens and loads its own content', async ({ page }) => {
  test.slow()
