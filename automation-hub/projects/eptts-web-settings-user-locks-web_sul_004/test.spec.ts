/**
 * WEB_SUL_004 — Validate that the User Locks tab reloads its data after a page refresh
 *
...
test('WEB_SUL_004 — Validate that the User Locks tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
