/**
 * WEB_RPT_009 — Validate that the page handles an expired session
 *
...
test('WEB_RPT_009 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/reporting').expectEnglish()
