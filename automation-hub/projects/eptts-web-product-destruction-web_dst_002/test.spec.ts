/**
 * WEB_DST_002 — Validate that /destruction is reachable by direct URL and survives a refresh
 *
...
test('WEB_DST_002 — Validate that /destruction is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/destruction')
    .expectEnglish()
    .expectSurvivesReload('/destruction')
    .expectNoErrorBanner()
})
