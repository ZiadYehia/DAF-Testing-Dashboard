/**
 * WEB_AMD_003 — Validate that Master-data changes data is not carried over from another tab
 *
...
test('WEB_AMD_003 — Validate that Master-data changes data is not carried over from another tab', async ({ page }) => {
  test.slow()
