/**
 * WEB_SSY_003 — Validate that System data is not carried over from another tab
 *
...
test('WEB_SSY_003 — Validate that System data is not carried over from another tab', async ({ page }) => {
  test.slow()
