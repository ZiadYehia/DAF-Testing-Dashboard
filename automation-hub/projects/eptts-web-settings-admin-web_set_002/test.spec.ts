/**
 * WEB_SET_002 — Validate that /admin is reachable by direct URL and survives a refresh
 *
...
test('WEB_SET_002 — Validate that /admin is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
