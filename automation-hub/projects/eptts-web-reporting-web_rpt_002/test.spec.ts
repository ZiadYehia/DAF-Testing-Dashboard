/**
 * WEB_RPT_002 — Validate that /reporting is reachable by direct URL and survives a refresh
 *
...
test('WEB_RPT_002 — Validate that /reporting is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/reporting')
    .expectEnglish()
    .expectSurvivesReload('/reporting')
    .expectNoErrorBanner()
})
