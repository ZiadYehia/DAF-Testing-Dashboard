/**
 * WEB_AGG_002 — Validate that /aggregation is reachable by direct URL and survives a refresh
 *
...
test('WEB_AGG_002 — Validate that /aggregation is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/aggregation')
    .expectEnglish()
    .expectSurvivesReload('/aggregation')
    .expectNoErrorBanner()
})
