/**
 * WEB_XML_006 — Validate that the page handles an expired session
 *
...
test('WEB_XML_006 — Validate that the page handles an expired session', async ({ page, context }) => {
  test.slow()
  await DashboardPage.open(page, '/bulk-upload').expectEnglish()
