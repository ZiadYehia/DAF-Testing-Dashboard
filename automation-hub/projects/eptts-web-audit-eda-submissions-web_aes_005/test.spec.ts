/**
 * WEB_AES_005 — Validate that EDA submissions rejects a GLN with an invalid check digit
 *
...
test('WEB_AES_005 — Validate that EDA submissions rejects a GLN with an invalid check digit', async ({ page }) => {
  test.slow()
