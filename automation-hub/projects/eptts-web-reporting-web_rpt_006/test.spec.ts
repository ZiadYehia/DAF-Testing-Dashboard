/**
 * WEB_RPT_006 — Validate that search handles a no-match value without error
 *
...
test('WEB_RPT_006 — Validate that search handles a no-match value without error', async ({ page }) => {
  test.slow()
