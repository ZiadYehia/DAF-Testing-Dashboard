/**
 * WEB_AIN_001 — Integrity renders with its content and primary controls.
 *
 * Feature: web-audit-integrity   Route: /audit
 *
...
test('WEB_AIN_001 — Integrity renders', async ({ page }) => {
  test.slow()
  await DashboardPage.openTab(page, '/audit', 'Integrity')
    .expectEnglish()
    .expectControls(['Export CSV', 'Verify'])
    .expectTableColumns(['GLN', 'EVENTS', 'FIRST EVENT', 'LAST EVENT', 'LAST VERIFIED'])
