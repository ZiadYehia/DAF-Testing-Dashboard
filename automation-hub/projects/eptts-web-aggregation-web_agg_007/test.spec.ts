/**
 * WEB_AGG_007 — Validate that the page surfaces a backend failure instead of failing silently
 *
...
test('WEB_AGG_007 — Validate that the page surfaces a backend failure instead of failing silently', async ({ page }) => {
  test.slow()
