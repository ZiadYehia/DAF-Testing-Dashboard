/**
 * WEB_INV_002 — Validate that /inventory is reachable by direct URL and survives a refresh
 *
...
test('WEB_INV_002 — Validate that /inventory is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/inventory')
    .expectEnglish()
    .expectSurvivesReload('/inventory')
    .expectNoErrorBanner()
})
