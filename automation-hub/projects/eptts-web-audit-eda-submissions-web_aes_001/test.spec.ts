/**
 * WEB_AES_001 — Validate that the EDA submissions tab opens and loads its own content
 *
...
test('WEB_AES_001 — Validate that the EDA submissions tab opens and loads its own content', async ({ page }) => {
  test.slow()
