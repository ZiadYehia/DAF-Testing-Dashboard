/**
 * WEB_AIN_004 — Validate that the Integrity tab reloads its data after a page refresh
 *
...
test('WEB_AIN_004 — Validate that the Integrity tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
