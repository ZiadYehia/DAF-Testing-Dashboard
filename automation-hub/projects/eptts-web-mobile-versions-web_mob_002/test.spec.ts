/**
 * WEB_MOB_002 — Validate that /mobile-versions is reachable by direct URL and survives a refresh
 *
...
test('WEB_MOB_002 — Validate that /mobile-versions is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/mobile-versions')
    .expectEnglish()
    .expectSurvivesReload('/mobile-versions')
    .expectNoErrorBanner()
})
