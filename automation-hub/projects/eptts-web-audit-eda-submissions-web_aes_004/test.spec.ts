/**
 * WEB_AES_004 — Validate that the EDA submissions tab reloads its data after a page refresh
 *
...
test('WEB_AES_004 — Validate that the EDA submissions tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
