/**
 * WEB_RCV_001 — Validate that the Receiving page renders with its heading and primary controls
 *
...
test('WEB_RCV_001 — Validate that the Receiving page renders with its heading and primary controls', async ({ page }) => {
  test.slow()
