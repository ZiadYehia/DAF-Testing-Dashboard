/**
 * WEB_IPK_005 — Validate that the page surfaces a backend failure instead of failing silently
 *
...
test('WEB_IPK_005 — Validate that the page surfaces a backend failure instead of failing silently', async ({ page }) => {
  test.slow()
