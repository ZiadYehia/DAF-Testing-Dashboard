/**
 * WEB_SPL_004 — Validate that the Platform tab reloads its data after a page refresh
 *
...
test('WEB_SPL_004 — Validate that the Platform tab reloads its data after a page refresh', async ({ page }) => {
  test.slow()
