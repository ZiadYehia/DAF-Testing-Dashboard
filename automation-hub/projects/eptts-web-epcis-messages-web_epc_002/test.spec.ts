/**
 * WEB_EPC_002 — Validate that /epcis-b2b is reachable by direct URL and survives a refresh
 *
...
test('WEB_EPC_002 — Validate that /epcis-b2b is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
  await DashboardPage.open(page, '/epcis-b2b')
    .expectEnglish()
    .expectSurvivesReload('/epcis-b2b')
    .expectNoErrorBanner()
})
