/**
 * WEB_AUD_002 — Validate that /audit is reachable by direct URL and survives a refresh
 *
...
test('WEB_AUD_002 — Validate that /audit is reachable by direct URL and survives a refresh', async ({ page }) => {
  test.slow()
